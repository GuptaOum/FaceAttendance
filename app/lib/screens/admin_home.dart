...
import '../api.dart';
import 'absence_alerts_screen.dart';
...
class _AdminHomeState extends State<AdminHome> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Parent WhatsApp (optional)',
                  hintText: '+919876543210',
                  helperText: 'Used for absence alerts. Country code required.',
                ),
              ),
            ],
          ),
  ...
  Future<void> _editPhoneDialog(Map<String, dynamic> s) async {
    ...
    final saved = await showDialog<bool>(
      context: context,
      builder: (ctx) => AlertDialog(
        title: Text('Parent WhatsApp for ${s['name']}'),
        content: TextField(
          controller: phone,
          keyboardType: TextInputType.phone,
          autofocus: true,
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'Absence alerts',
            onPressed: () => Navigator.push(
                context, MaterialPageRoute(builder: (_) => const AbsenceAlertsScreen())),
          ),
          IconButton(
                        ...
                        trailing: Row(
                          ...
                          children: [
                            IconButton(
                              ...
                              tooltip:
                                  phone.isEmpty ? 'Add parent phone' : 'Edit parent phone',
